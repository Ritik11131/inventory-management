        ...
        },
         {
            ...
            api:'report/Summary/GetDistance',
             tableColumns: [
                 ...
                 { field: 'device', subfield: 'imei', header: 'IMEI', nested: true, },
                 { field: 'vehicle', subfield: 'vehicleNo', header: 'Vehicle Name', nested: true, },
                 { field: 'distance', subfield: 'total', header: 'Vehicle Sno', nested: true, },
        ...
        },
         {
            ...
            api:'report/Summary/GetSummary',
             tableColumns: [
                 ...
                 { field: 'summary', subfield: 'firstIgnitionTime', header: 'First Ignition Time', nested: true },
                 ...
                 { field: 'summary', subfield: 'lastIgnitionTime', header: 'Last Ignition Time', nested: true },
                 { field: 'summary', subfield: 'totalDistance', header: 'Total Distance', nested: true },
                 { field: 'summary', subfield: 'firstFixTime', header: 'First Fix Time', nested: true },
                 { field: 'summary', subfield: 'lastFixTime', header: 'Last Fix Time', nested: true },
                 ...
                 { field: 'summary', subfield: 'attribute', header: 'Attribute', nested: true },
             ],
