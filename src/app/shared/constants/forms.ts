...
export const deviceTransferInventoryFormFields : FormFields[] = [
    ...
    {
        name: 'from_device',
        label: 'From Device No',
        type: 'text',
        hide: (hideFields: string[]) => hideFields.includes('from_imei'),
    },
    {
        name: 'to_device',
        label: 'To Device No',
        type: 'text',
        hide: (hideFields: string[]) => hideFields.includes('to_imei'),
    },
    {
        name: 'no_of_device',
...
export const fitmentFormFields : any[] = [
    {
      ...
      fields: [
        ...
        { type: 'text', name: 'vehicleModel', label: 'Vehicle Model', placeholder: 'Enter Vehicle Model', disabled:false },
        { type: 'date', view:'year', dateFormat:'yy', name: 'manufacturingYear', label: 'Manufacturing Year', placeholder: 'Enter Manufacturing Year', disabled:false },
    ...
    },
    {
      ...
      fields: [
        ...
        { type: 'text', name: 'permitHolderMobile', label: 'Contact No', placeholder: 'Enter Contact No', mandatory:true },
        { type: 'text', name: 'aadhaarNumber', label: 'Aadhar No', placeholder: 'Enter Aadhar No', mandatory:true  }
      ]
    }
];